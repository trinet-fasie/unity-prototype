...
func (a *API) AddObjectTag(w http.ResponseWriter, r *http.Request) {
	...
	t, err := repository.GetObjectTagByText(a.db, dto.Text)
	if err != nil && err != sql.ErrNoRows {
		a.ReportInternalError(w, r, err)
		return
	}
	if err == sql.ErrNoRows {
		t = new(repository.ObjectTag)
		t.Text = dto.Text
