...
func TestLocationsApi(t *testing.T) {
	Convey("Given error in database", t, func() {
		...
		sqlMocker.ExpectQuery(`SELECT.*FROM\s+locations`).WillReturnError(errors.New("some database error"))

		Convey("When client GET /v1/locations", func() {
			res, err := http.Get(ts.URL + "/v1/locations")
...
`)
	...
	Convey("Given no rows in database", t, func() {
		...
		Convey("When GET /v1/locations", func() {
			res, err := http.Get(ts.URL + "/v1/locations")
...
`)
	...
	Convey("Given some rows in database", t, func() {
		...
		rows := sqlmock.NewRows([]string{"id", "guid", "name", "usages", "created_at", "updated_at"}).
			...
			AddRow(2, "c949de70-7e44-42b7-b34e-b84efd1afbf2", "Location 2", 0, "2018-01-01 00:00:00", "2018-01-02 00:00:00")
				...
				So(res, ShouldBeValidSuccessJsonResponse, `
{
  ...
  "Data": [
    ...
    },
    {
      ...
      "Name": "Location 2",
      "Resources": {
        "Bundle": "/v1/locations/resources/c9/c949de70-7e44-42b7-b34e-b84efd1afbf2/bundle",
        "Config": "/v1/locations/resources/c9/c949de70-7e44-42b7-b34e-b84efd1afbf2/bundle.json",
        "DllPath": "/v1/locations/resources/c9/c949de70-7e44-42b7-b34e-b84efd1afbf2",
        "Icon": "/v1/locations/resources/c9/c949de70-7e44-42b7-b34e-b84efd1afbf2/bundle.png",
        "Manifest": "/v1/locations/resources/c9/c949de70-7e44-42b7-b34e-b84efd1afbf2/bundle.manifest"
      },
      "Usages": 0
    }
  ]
